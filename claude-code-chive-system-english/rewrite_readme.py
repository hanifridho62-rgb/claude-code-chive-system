readme_en = """# CHIVE: Architectural Governance & Self-Healing Skill System for Claude Code
...
with open("/tmp/claude_chive_system/README.md", "w", encoding="utf-8") as f:
    f.write(readme_en.strip() + "\n")

print("README.md rewritten in English.")
